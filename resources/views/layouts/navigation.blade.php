<nav x-data="{ open: false }" class="bg-gradient-to-b from-blue-600 to-blue-400 dark:bg-gradient-to-b dark:from-blue-800 dark:to-blue-700 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo Treasure Chest / Skattekiste -->
                <div class="shrink-6 md:shrink-3 flex items-center">
                    <a href="{{ route('dashboard') }}">
                    <img class="size-80 drop-shadow-lg" src="https://ouch-cdn2.icons8.com/5iRXIex6ENAJfhSm6GxYntqBKoM2lSzRffmJl3YSyws/rs:fit:368:368/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvNTEz/L2ExMTRiYjEzLWUz/ZjktNGVlZS1hMTcy/LTgzYmM4OWE5MDQ1/YS5wbmc.png" alt="Loot">
                    </a>
                </div>
