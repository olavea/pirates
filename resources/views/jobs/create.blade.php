    ...
    <form method="POST" action="/tall_tales">
        ...
        <div class="space-y-12">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <br />
                <h2 class="mt-9 text-3xl font-black text-gray-900">Tell Your Tale</h2>
                <p class="mt-6 text-gray-600">We just need a handful of details from you.</p>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4 mt-6">
                            <label for="salary" class="block text-sm/6 font-bold text-gray-900">Your Tall Tale</label>
                            <div class="mt-2">
                                <div class="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                    <input 
                                        type="text" 
                                        ...
                                        placeholder="1 million $ tall tale" >
                                </div>
                                @error('salary')
                                    <p class="text-red-500 font-bold">{{ $message }}</p>
                                @enderror
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <button
                        href="/tales" 
                        type="button" 
                        class="text-xl font-semibold hover:underline text-gray-900">Cancel</button>
